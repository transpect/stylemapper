...
tl.pg.pageGuideList = tl.pg.pageGuideList ||[], tl.pg.interval = {
},
function (a) {
    tl.pg.default_prefs = {
        auto_show_first: ! 0, loading_selector: "#loading", track_events_cb: function () {
        },
        handle_doc_switch: null, custom_open_button: null, pg_caption: "page guide", tourtitle: "Open Page Guide for help", check_welcome_dismissed: function () {
        ...
        ready_callback: null, pointer_fallback: ! 0, default_zindex: 100, steps_element: "#tlyPageGuide", auto_refresh: ! 1, refresh_welcome: ! 1, refresh_interval: 500
    },
    tl.pg.wrapper_markup = '<div id="tlyPageGuideWrapper"><div id="tlyPageGuideOverlay"></div><div id="tlyPageGuideMessages"><a href="#" class="tlypageguide_close" title="Close Guide">close</a><span class="tlypageguide_index"></span><div class="tlypageguide_text"></div><a href="#" class="tlypageguide_back" title="Previous">Previous</a><a href="#" class="tlypageguide_fwd" title="Next">Next</a></div><div id="tlyPageGuideContent"></div><div id="tlyPageGuideToggles"></div></div>', tl.pg.toggle_markup = '<div class="tlypageguide_toggle" title="Launch Page Guide"><div><span class="tlypageguide_toggletitle"></span></div><a href="#" class="tlypageguide_close" title="close guide">close guide &raquo;</a></div>', tl.pg.init = function (b) {
        ...
        tl.pg.default_prefs, b);
        var c = a(b.steps_element), d = tl.pg.hashCode(b.steps_element);
        if (clearInterval(tl.pg.interval[d]), 0 !== c.length) {
            b.pointer_fallback && tl.pg.pointerEventSupport() &&(b.pointer_fallback = ! 1);
            var e = a("#tlyPageGuideWrapper"), f = ! 0;
            if (e.length ||(f = ! 1, e = a(tl.pg.wrapper_markup)), null == b.custom_open_button && a("#tlyPageGuideToggle" + d).length < 1) {
                var g = c.data("tourtitle") || b.tourtitle, h = a(tl.pg.toggle_markup).attr("id", "tlyPageGuideToggle" + d).prepend(b.pg_caption);
    ...
    tl.pg.isScrolledIntoView = function (b, c) {
        var d = a(window).scrollTop(), e = d + a(window).height(), f = a(b).offset().top, g = f + a(b).height();
        return f >= d && e - c >= g
    },
    ...
    tl.pg.pointerEventSupport = function () {
        var a = document.createElement("x"), b = document.documentElement, c = window.getComputedStyle, d = null;
    ...
    tl.pg.PageGuide.prototype.setup_welcome = function () {
        var b = a(".tlyPageGuideWelcome, #tlyPageGuideWelcome").not("#tlyPageGuideWrapper > .tlyPageGuideWelcome, #tlyPageGuideWrapper > #tlyPageGuideWelcome").eq(0), c = this;
    ...
    tl.pg.PageGuide.prototype.addSteps = function () {
        ...
        b.$steps.find("li").each(function (c, d) {
            var e = a(d), f = e.data("tourtarget"), g = e.attr("class");
            if (null == b.targetData[f]) {
                ...
                var h = tl.pg.hashCode(f) + ""; b.hashTable[h] = f, b.$content.append('<div class="tlypageguide_shadow tlypageguide_shadow' + h + '" data-selectorhash="' + h + '"><span class="tlyPageGuideStepIndex ' + g + '"></span></div>')
            }
        })
    },
    tl.pg.PageGuide.prototype.checkTargets = function () {
        ...
        for (var e in b.targetData) {
            ...
            i = 0; i < g.length; i++) if (a(g[i]).is(":visible")) {
                f = a(g[i]), h.targetStyle.display = "block";
                var j = f.offset();
                a.extend(h.targetStyle, {
                    top: j.top, left: j.left, width: f.outerWidth(), height: f.outerHeight(), "z-index": f.css("z-index")
            ...
            for (var l in h.targetStyle) h.targetStyle[l] !== b.targetData[e][l] &&(null == k.targetStyle &&(k.targetStyle = {
            }), k.targetStyle[l] = h.targetStyle[l]);
    ...
    tl.pg.PageGuide.prototype.positionOverlays = function () {
        for (var b = 0; b < this.changeQueue.length; b++) {
            var c = this.changeQueue[b], d = ".tlypageguide_shadow" + tl.pg.hashCode(c.target), e = this.$content.find(d);
    ...
    tl.pg.PageGuide.prototype.show_message = function (b) {
        var c = this.visibleTargets[b], d = this.targetData[c];
        if (null != d) {
            var e = ".tlypageguide_shadow" + tl.pg.hashCode(c);
            if (this.handle_doc_switch) {
                var f = this.visibleTargets.length, g = this.visibleTargets[(b -1 + f) % f];
            ...
            var h = 100, i = parseFloat(this.$message.css("height"));
    ...
    tl.pg.PageGuide.prototype.setup_handlers = function () {
        var b = this, c = null == b.custom_open_button ? b.$base.find("#tlyPageGuideToggle" + b.uuid): a(b.custom_open_button);
        c.off(), c.on("click", function () {
            ...
            var c = b.hashTable[a(this).parent().data("selectorhash")], d = b.targetData[c], e = d ? d.index: 1; b.track_event("PG.specific_elt"), b.show_message(e -1)
